...
class Puremedia_Tag_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_ops = array(
			...
			'description' 	=> esc_html__('Display Tags', 'puremedia'),
		);
		parent::__construct( 'pm_tag', esc_html__('Puremedia: Tags Widget', 'puremedia'), $widget_ops );
	...
	public function form( $instance ) {
		...
		<p>
			...
			<input type="text" class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" value="<?php echo esc_attr( $title ); ?>" placeholder="<?php echo esc_html__('Ex: Tags', 'puremedia') ?>">
		</p>
